...
/***/ function(module, exports, __webpack_require__) {
	...
	!(function (a, b) {
	  ...
	  var c = [],
	    ...
	    return this.length;
	  }, m.fn.andSelf = m.fn.addBack, "function" == "function" && __webpack_require__(41) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return m;
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function ($) {
		...
		$.fn.extend({
			barcode: function barcode(settings) {
		...
		$.barcode._encode64 = function (input) {
			...
			do {
				...
				output = output + $.barcode._encode64.keyStr.charAt(enc1) + $.barcode._encode64.keyStr.charAt(enc2) + $.barcode._encode64.keyStr.charAt(enc3) + $.barcode._encode64.keyStr.charAt(enc4);
		...
		$.barcode._multiByteEncode = function (number, bytes) {
			...
			if (number != 0) throw 'Overflow, number too big for string length';
			return string;
		};
		...
		$.barcode._createBmp = function (grid, palette) {
			...
			var padding;
			if (width % 4 == 1) padding = '\0\0\0';else if (width % 4 == 2) padding = '\0\0';else if (width % 4 == 3) padding = '\0';else padding = '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (wndw, factory) {
		...
		var RoundProgressModule = function RoundProgressModule($) {
			var _private = {
				defaults: {
				...
				getOrMakeObject: function getOrMakeObject(elem, options) {
				...
				customize: function customize(options) {
					...
					// Sub container
					if ($subContainer.length > 0) $subContainer.appendTo($ProgressbarContainer);

					// Draw progress
					$ProgressbarContainer.append(_p._drawProgressbar.call(this));

					// Run / Pause gearwheel
					if (this.options.displayGearwheel) _p.runningGearwheel.call(this);else _p.hideGearwheel.call(this);
				},
				_drawProgressbar: function _drawProgressbar() {
				...
				_drawProgressTrack: function _drawProgressTrack() {
					var $progressTrack = $("<canvas></canvas>").addClass("round-block__track").attr({
						"width": this.diameter,
						"height": this.diameter
					}).appendTo(this.$elem);
				...
				_rotateImage: function _rotateImage(canvas, ctx, degree, img) {
				...
				refreshValue: function refreshValue() {
					...
					var animate = function animate(timestamp) {
						...
						if (startPercent < endPercent) {
							newPercent = (function (d, s, e, i) {
								return s + that.animateStyle(d / i) * (e - s);
							})(deltaTime, startPercent, endPercent, that.options.interval);
						} else {
							//revert animate
							newPercent = (function (d, s, e, i) {
								return s - that.animateStyle(d / i) * (s - e);
							})(deltaTime, startPercent, endPercent, that.options.interval);
						}
						curPercent = newPercent;

						if (deltaTime >= that.options.interval) {
				...
				stopGearwheel: function stopGearwheel() {
					clearInterval(this.gearwheel_rotate_anticlockwise);
				},
				runningGearwheel: function runningGearwheel() {
					this.showGearwheel();
					this.stopGearwheel();
					var degree = 0;
					var that = this;
				...
				hideGearwheel: function hideGearwheel() {
					this.gearWheel.addClass("hide");
				},
				showGearwheel: function showGearwheel() {
			...
			EventTarget.prototype = {
				...
				fire: function fire(eventName, value) {
			...
			var RoundProgress = function RoundProgress(elem, options) {
				this.$elem = $(elem);
			...
			var _public = function _public(el, options) {
